...
export function MusicPlayer({
  ...
  // Whether the next loaded track should auto-start
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3 -top-3 z-20 flex h-9 w-9 items-center justify-center rounded-full border border-white/20 bg-black/60 backdrop-blur-md transition-transform hover:scale-105 active:scale-95 text-white"
      >
      ...
      {artwork ? (
        <img
          ...
          className="absolute -top-5 left-0 z-20 h-20 w-20 rounded-xl object-cover shadow-lg shadow-black/40 ring-1 ring-white/20"
        />
      ) : null}

      {/* Player bar */}
      <div className="relative flex h-[70px] items-center gap-3 overflow-hidden rounded-xl border border-white/15 bg-black/40 pl-24 pr-5 backdrop-blur-md">
        {/* Equalizer */}
        ...
        >
          <div className="min-w-0 flex-1">
            <div className="truncate text-xs sm:text-sm font-semibold uppercase tracking-wide text-white">
              {track.title}
            </div>
            <div className="truncate text-[0.65rem] uppercase tracking-[0.2em] text-white/60">
              {track.artist}
            </div>
          </div>
          ...
          <div className="flex shrink-0 items-center gap-1">
            <button
              ...
              className="rounded-full p-1.5 opacity-80 transition hover:bg-white/10 hover:opacity-100 text-white"
            >
            ...
            <button
              ...
              className="rounded-full p-1.5 opacity-90 transition hover:bg-white/10 hover:opacity-100 text-white"
            >
              {isPlaying ? (
